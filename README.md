...
## Каждую задачу отметил комментарием.

[![Build status](https://ci.appveyor.com/api/projects/status/npml0k6xfbe1gf1h?svg=true)](https://ci.appveyor.com/project/RT-Vinsent/ajs-homeworks-7)
